...
Before the lecture, I felt nervous as machine learning and classification seemed challenging. However, unlike GEE, these techniques have long been used in remote sensing to categorise pixels, objects, or patterns into thematic classes. Here is a very interesting example where a nonprofit organisation used satellite technology and machine learning to combat illegal fishing:
...
![](machine_learning.png){fig-align="center" width="566"}
...
![Framework of the proposed method for mangrove ecosystem mapping using the random forest (Ghorbanian et al., 2021)](mangrove.jpg){fig-align="center"}
